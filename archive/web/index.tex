...
\begin{itemize}
\item Graduate Student, Department of Computer Science, Oklahoma State University
\item {\it Office}: MSCS 314, Stillwater, OK 74075
\item {\it Website}: \verb http://cs.okstate.edu/~shiyu \quad
\item {\it Email}: \verb shiyu \quad \verb AT \quad \verb cs.okstate.edu \quad
\end{itemize}
